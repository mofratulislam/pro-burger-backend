...
class CustomerDetail(models.Model):
    ...
    paymentType = models.CharField(max_length=255 , blank=True)

    def __str__(self):
        return self.deliveryAddress + self.phone

class Order(models.Model):
    user = models.ForeignKey(UserProfile, on_delete=models.CASCADE)
    ingredients = models.OneToOneField(Ingredient, on_delete=models.CASCADE, null=True)
    customer = models.ForeignKey(CustomerDetail, on_delete=models.CASCADE, null=True)
